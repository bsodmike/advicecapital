...
namespace :stock_table do
  ...
  task :setup  => :environment do
    ...
    stock = [{:symbol=>"MAERSK-B.CO", :price=>"35900.00", :change=>"-380.00",:volume=>"6653"},
     {:symbol=>"CARL-B.CO", :price=>"397.30", :change=>"+8.30", :volume=>"568789"},
     {:symbol=>"CRTSF.PK", :price=>"20.95", :change=>"0.00", :volume=>"0"},
     {:symbol=>"COLO-B.CO", :price=>"806.00", :change=>"+28.50", :volume=>"93403"},
     {:symbol=>"DNORD.CO", :price=>"154.70", :change=>"-0.30", :volume=>"91185"},
     ...
     {:symbol=>"PNDORA.Co", :price=>"47.21", :change=>"+0.71", :volume=>"498105"},
